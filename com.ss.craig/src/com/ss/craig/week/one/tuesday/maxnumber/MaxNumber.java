...
public class MaxNumber {
     ...
     * 
     * @return : returns array of three integers int[0] = max number int[1] = one
     *         dimentional index int[2] = two dimentional index
     */
    ...
    /**
     * Constructs a two dimensional array with random numbers of elements and random
     * numbers per element
     */
    ...
    /**
     * Creates a random number with Math.random accounting for min and max values
     * supplied
     * 
