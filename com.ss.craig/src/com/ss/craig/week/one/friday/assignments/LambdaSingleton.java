...
public class LambdaSingleton extends InputUtility{
    ...
    public boolean chooseAssignment(Integer n) throws Exception
    {
        ...
        case 4:
            ...
            break;
        case 5:
            System.out.println("Use random_date.minus(1, ChronoUnit.WEEKS) to get the day one week before the random date\n"+
            ...
            System.out.println("Random Date: "+DateTimeFormatter.ISO_LOCAL_DATE.format(random_date)+
                    "\nPrevious Thursday: "+DateTimeFormatter.ISO_LOCAL_DATE.format(dt_examples.getPreviousThursday(random_date)));
            break;
        case 6:
        ...
        case 7:
            ...
            System.out.println("From Insant to ZonedDateTime: instant.atZone(zone_id)\n"+
                    ...
                    "\nChange the ZoneId to UTC: "+ztd.withZoneSameInstant(ZoneOffset.UTC)+
                    "\nand back to an instant: "+dt_examples.getInstant(ztd));
            break;
        case 8:
        ...
        case 10:
            System.out.println("Is today Friday the Thirteenth? "+dt_examples.isFridayThirteenth(LocalDate.now())+
                    "\nIs Friday, August 13, 2021 Friday the Thirteenth? "+ dt_examples.isFridayThirteenth(LocalDate.of(2021, 8, 13)));
            break;
        default:
