...
public class BookingGuest implements Serializable {
     ...
     * 
     */
    private static final long serialVersionUID = -6055837002689821042L;
    ...
    @OneToMany(mappedBy="bookingGuest")
    ...
    /**
     * Compares the key for this instance with another BookingGuest.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class BookingGuest and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof BookingGuest)) {
            return false;
        }
        BookingGuest that = (BookingGuest) other;
    ...
    /**
     * Compares this instance with another BookingGuest.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        if (!(other instanceof BookingGuest)) return false;
        return this.equalKeys(other) && ((BookingGuest)other).equalKeys(this);
    }
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("[BookingGuest |");
